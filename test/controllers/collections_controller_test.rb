...
class CollectionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create collection" do
    assert_difference('Collection.count') do
      post collections_url, params: { collection: { album: @collection.album, artist: @collection.artist, year: @collection.year } }
    end
  ...
  test "should update collection" do
    patch collection_url(@collection), params: { collection: { album: @collection.album, artist: @collection.artist, year: @collection.year } }
